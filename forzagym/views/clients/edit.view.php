...
<div id="app">
  ...
  <div class="main">
    <div class="topbar">
      <div>
        <h2><?= $heading ?></h2>
        <div class="sub">Actualiza la información de <?= htmlspecialchars($client['first_name']) ?></div>
      </div>
    </div>
    <div class="content">
      ...
      <div class="form-card">
        <form method="POST" action="<?= BASE_URL ?>/clients/edit">
          ...
          <div class="form-grid">
            ...
            <div class="field">
              ...
              <input id="cl-phone" name="phone" type="text" value="<?= htmlspecialchars($client['phone'] ?? '') ?>">
