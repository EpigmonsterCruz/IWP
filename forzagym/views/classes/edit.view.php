...
<div id="app">
  ...
  <div class="main">
    <div class="topbar">
      <div>
        <h2><?= $heading ?></h2>
        <div class="sub">Actualiza los datos de esta clase</div>
      </div>
    </div>
    <div class="content">
      ...
      <div class="form-card">
        <form method="POST" action="<?= BASE_URL ?>/classes/edit">
          ...
          <div class="form-grid">
            ...
            <div class="field">
              ...
              <input id="cs-location" name="location" type="text" value="<?= htmlspecialchars($class['location'] ?? '') ?>">
              <p class="err"><?= $error['location'] ?? '' ?></p>
            </div>
            <div class="field">
              <label for="cs-time">Horario</label>
              <input id="cs-time" name="schedule_time" type="time" value="<?= htmlspecialchars(substr($class['schedule_time'] ?? '', 0, 5)) ?>">
