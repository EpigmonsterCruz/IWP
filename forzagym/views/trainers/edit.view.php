...
<div id="app">
  ...
  <div class="main">
    <div class="topbar">
      <div>
        <h2><?= $heading ?></h2>
        <div class="sub">Actualiza la información de <?= htmlspecialchars($trainer['first_name']) ?></div>
      </div>
    </div>
    <div class="content">
      ...
      <div class="form-card">
        <form method="POST" action="<?= BASE_URL ?>/trainers/edit">
          ...
          <div class="form-grid">
            ...
            <div class="field">
              ...
              <input id="tr-phone" name="phone" type="text" value="<?= htmlspecialchars($trainer['phone'] ?? '') ?>">
              <p class="err"><?= $error['phone'] ?? '' ?></p>
            </div>
            <div class="field full">
              <label for="tr-spec">Especialización</label>
              <input id="tr-spec" name="specialization" type="text" value="<?= htmlspecialchars($trainer['specialization'] ?? '') ?>">
